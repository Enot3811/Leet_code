...
# Размышления
# Задача с завышенной сложностью и без подвохов.
# Проходим по узлам, рекурсивно считаем значение веток.
# Если ветка отрицательная, то можно её не брать.
# Единственная особенность здесь в том, что можно смотреть на узел как на корень решения
# и как на ветку другого решения.
# Если корень, то можно прибавить обе ветки, а если ветка, то придётся взять лишь одну
# из веток
