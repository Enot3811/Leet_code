...
# Размышления
# Если массив отсортирован, то мы можем взять два его края и просуммировать.
# Если сумма меньше таргета, то значит нужно её увеличить - двигаем левый край
# (он становится больше).
# Если сумма больше, то двигаем правый (заменяем большее число на число поменьше)
