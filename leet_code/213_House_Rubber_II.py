...
# Размышления
# Задача относится к House Rubber I (198).
# Ограничение, добавленное в этой версии, если мы грабим дом 1, то не можем грабить
# последний, и наоборот, но в остальном решение всё то же.
# Трюк, позволяющий решить задачу: решим её два раза. Первый включая нулевой дом, но
# исключая последний, и наоборот, включая последний, но исключая нулевой.
